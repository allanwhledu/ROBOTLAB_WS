...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_description_SOURCE_PREFIX /home/whl/ROBOTLAB_WS/src/turtlebot3-melodic-devel/turtlebot3_description)
  set(turtlebot3_description_DEVEL_PREFIX /home/whl/ROBOTLAB_WS/src/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/whl/ROBOTLAB_WS/src/turtlebot3-melodic-devel/turtlebot3_description/${idir}'.  ${_report}")
    endif()
